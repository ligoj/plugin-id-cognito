...
// Library build for the "id-cognito" tool-level plugin.
//
...
export default defineConfig({
  ...
  build: {
    ...
    outDir: resolve(
      import.meta.dirname,
      '../src/main/resources/META-INF/resources/webjars/id-cognito/vue',
    ),
    emptyOutDir: true,
    rollupOptions: {
  ...
  // Ligoj backend on :8080. `npm run dev` then open http://localhost:5318/.
  server: {
    port: 5318,
    proxy: {
